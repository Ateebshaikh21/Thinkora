...
cors_origins = os.getenv("CORS_ORIGINS", "http://localhost:3000,http://localhost:3001,http://localhost:5173,https://frontend-gnievugal-ateebshaikh0821-8173s-projects.vercel.app")
